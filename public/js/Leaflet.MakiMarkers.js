...
(function () {
    ...
    L.MakiMarkers = {
        accessToken:
            "pk.eyJ1IjoiZGVkZWJrYyIsImEiOiJjazRpN2kzeDcxaTN3M25uYTJ6ZmppamNlIn0.sDaANc66YGV2nEL2drbn9Q",
        defaultColor: "#0a0",
    ...
    L.MakiMarkers.Icon = L.Icon.extend({
        ...
        initialize: function (options) {
            ...
            if (!accessToken) {
                throw new Error(
                    "Access to the Mapbox API requires a valid access token."
                );
            }
            ...
            options.iconUrl =
                "" + L.MakiMarkers.apiUrl + pin + ".png" + tokenQuery;
            options.iconRetinaUrl =
                L.MakiMarkers.apiUrl + pin + "@2x.png" + tokenQuery;
        },
    });
